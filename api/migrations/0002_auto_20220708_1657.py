# Generated by Django 3.2.5 on 2022-07-08 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score_rule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.scorerule', verbose_name='关联规则')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.account')),
                ('course', models.ForeignKey(limit_choices_to=models.Q(('course_type', 2), _negated=True), on_delete=django.db.models.deletion.CASCADE, to='api.course')),
                ('order_detail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.orderdetail')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(blank=True, max_length=255, null=True)),
                ('enrolled_degree', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.enrolleddegreecourse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.homework')),
                ('study_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.studyrecord')),
            ],
            options={
