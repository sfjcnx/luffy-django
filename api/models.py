...
class Account(models.Model):
    ...
    uid = models.CharField(max_length=64,  help_text='微信用户绑定和CC视频统计',unique=True)  # 与第3方交互用户信息时，用这个uid,以避免泄露敏感用户信息
...
class HomeworkRecord(models.Model):
    ...
    reward_status = models.SmallIntegerField(verbose_name='作业记录奖惩状态', default=0, choices=reward_choice)
